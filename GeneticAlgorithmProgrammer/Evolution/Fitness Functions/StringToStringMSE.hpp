...
#ifndef StringToStringMSE_cpp
#define StringToStringMSE_cpp

#include "StringToStringFitnessFunction.h"

/* The StringToStringMSE fitness function
 is an MSE (mean squared error) cost function
 that summates the squared discrepancy between
 the ASCII indexes of each respective character
 in the strings, and divides it by two times the
 strings' size.
 */
class StringToStringMSE : public StringToStringFitnessFunction {
    public:
