...
namespace constants {
    ...
    const double POPULATION_POOL_MUTATE_ADDITION_PROBABILITY = 0.20; // The probability that a given chromosome which will be mutated, will be mutated by adding a new character to the genome
    ...
    const double POPULATION_POOL_MUTATE_MODIFICATION_PROBABILITY = (1 - POPULATION_POOL_MUTATE_ADDITION_PROBABILITY - POPULATION_POOL_MUTATE_SUBTRACTION_PROBABILITY); // The probability that a given chromosome which will be mutated, will be mutated by changing a character in the genome
